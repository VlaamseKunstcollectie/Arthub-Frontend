...
module Blacklight::Catalog
    ...
    included do
      ...
      def show
        # The incoming :id parameter will be en:groeningemuseum:1234. This was
        # set in the before_action "switch_locale_of_document_id". The
        # fetch method will retrieve the 'en' document from the Solr index.
        @response, @document = fetch params[:id]

        # The @document is the 'en' document. The 'id' field of the document is
        # en:groeningemuseum:1234. All the template methods on the detail page wil use this
        # value to generate links (i.e. json variant, in the HTML meta <link>). However, 
        # this is not the URl we want. We call the 'set_id_on_locale' method on the @document
        # object to reset the :id to "groneingemuseum:1234"
        @document.set_id_on_locale()
